         ...
         <div className="flex items-center flex-grow border-2 rounded-full py-1 md:py-2 px-3 md:px-4 md:shadow-md hover:shadow-lg">
            ...
            <div className="flex items-center justify-center flex-grow cursor-pointer">
               <input
                  ...
                  className="bg-transparent md:flex-grow outline-none text-base md:text-base text-gray-600 placeholder-gray-600 focus:placeholder-gray-400 cursor-pointer" type="text" placeholder={placeholder || "Where are you going?"} />
