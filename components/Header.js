...
function Header({ placeholder }) {
   ...
   return (
      ...
      <header className="sticky top-0 z-50 grid md:grid-cols-3 grid-cols-1 bg-white shadow-md p-4 md:px-8">
         ...
         <div onClick={() => router.push("/")}
            className=" hidden justify-center pl-2 md:inline lg:hidden text-red-400"
         >
            <svg className="h-10 w-10 pt-2 cursor-pointer relative"
               layout="fill"
               objectFit="contain"
         ...
         {/* Middle-Search */}
         <div className="flex items-center border-2 rounded-full py-2 px-3 md:px-4 md:shadow-md hover:shadow-lg">
            <div className="flex items-center justify-center flex-grow cursor-pointer">
               <input
                  value={searchInput}
                  onChange={(e) => setSearchInput(e.target.value)}
                  className=" bg-transparent flex-grow outline-none text-sm md:text-base text-gray-600 placeholder-gray-700 cursor-pointer" type="text" placeholder={placeholder || "Where are you going?"} />
         ...
         <div className="flex items-center space-x-4 justify-end">
            ...
            <div className="hidden md:inline">
               <div className="flex items-center space-x-2 rounded-full p-2 hover:bg-gray-300 ">
