      ...
      <div>
         <DropdownMenu.Root>
            <DropdownMenu.Trigger className="flex">
               <DotsVerticalIcon className="h-6 items-center text-sm rounded-full cursor-pointer text-gray-500 hover:text-gray-900"/>
         ...
         <DropdownMenu.Content loop className="absolute top-1 -left-1 w-52 bg-white pl-1 pr-1 py-2 rounded-lg">
            ...
            <DropdownMenu.Item className="item">Log in</DropdownMenu.Item>
